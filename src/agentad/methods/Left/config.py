...
class LeftConfig:
    ...
    def original_gecco(cls) -> Self:
        return cls._original(
            ...
            projection_dropout=0.7,
            feedforward_dropout=0.7,
            dropout=0.7,
            fusion_dropout=0.2,
            fusion_feedforward_dim=128,
            decoder_dropout=0.5,
            decoder_feedforward_dim=256,
            prototypes=64,
            prototype_temperature=3.0,
            update_error_quantile=0.2,
            update_disagreement_quantile=0.2,
            memory_weight_max=0.1,
            latent_fusion_hidden=128,
            cycle_loss_weight=0.7,
            multiscale_loss_weight=0.25,
            consistency_loss_weight=0.05,
            cycle_score_weight=0.05,
            multiscale_score_weight=0.95,
            consistency_score_weight=0.0,
            residual_weight=0.4,
            fusion_weight=0.6,
            frequency_score_weight=0.5,
            time_score_weight=0.5,
            gate_score_weight=0.1,
            score_smoothing=15,
        )
    ...
    def original_psm(cls) -> Self:
        return cls._original(
            ...
            scale_factors=(4,),
            prototypes=128,
            memory_warmup_steps=1_000,
            memory_ramp_steps=2_000,
            latent_fusion_hidden=512,
            residual_weight=0.1,
            fusion_weight=0.9,
            cycle_score_weight=0.5,
            multiscale_score_weight=0.5,
            frequency_score_weight=0.2,
            time_score_weight=0.8,
            gate_score_weight=0.2,
            score_smoothing=3,
    ...
    def original_smd(cls) -> Self:
        return cls._original(
            ...
            dropout=0.2,
            prototypes=32,
            update_error_quantile=0.1,
            update_disagreement_quantile=0.1,
            memory_warmup_steps=1_000,
            memory_ramp_steps=2_000,
            memory_weight_max=0.2,
            latent_fusion_hidden=128,
            cycle_loss_weight=0.1,
            multiscale_loss_weight=0.85,
            consistency_loss_weight=0.1,
            cycle_score_weight=0.2,
            multiscale_score_weight=0.8,
            consistency_score_weight=0.1,
            residual_weight=0.3,
            fusion_weight=0.7,
            frequency_score_weight=0.9,
            time_score_weight=0.1,
            gate_score_weight=5.0,
            score_smoothing=51,
        )
    ...
    def original_swan(cls) -> Self:
        return cls._original(
            ...
            memory_ramp_steps=2_000,
            latent_fusion_hidden=128,
            cycle_loss_weight=0.2,
            multiscale_loss_weight=0.8,
            consistency_loss_weight=0.1,
            cycle_score_weight=0.5,
            multiscale_score_weight=0.5,
            consistency_score_weight=0.0,
    ...
    def original_swat(cls) -> Self:
        return cls._original(
            ...
            window_length=64,
            scale_factors=(16, 8),
            spectral_temperature=0.02,
            prototypes=32,
            prototype_temperature=3.0,
            latent_fusion_hidden=512,
            cycle_loss_weight=0.1,
            multiscale_loss_weight=0.9,
            consistency_loss_weight=0.0,
            cycle_score_weight=0.0,
            multiscale_score_weight=1.0,
            consistency_score_weight=0.0,
            residual_weight=0.4,
            fusion_weight=0.6,
            frequency_score_weight=0.5,
