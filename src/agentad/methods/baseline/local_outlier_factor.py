...
def evaluate(
    ...
    *,
    ...
    unit = unit_dir(output_root, "baseline/LocalOutlierFactor", split)
    results = unit_dir(results_root, "baseline/LocalOutlierFactor", split)
    prepare_run(
        unit,
        split,
        method="baseline/LocalOutlierFactor",
        partition=partition,
        seed=seed,
        hp=hp,
        resume=resume,
