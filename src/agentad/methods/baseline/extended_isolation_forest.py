...
def evaluate(
    ...
    *,
    ...
    unit = unit_dir(output_root, "baseline/ExtendedIsolationForest", split)
    results = unit_dir(results_root, "baseline/ExtendedIsolationForest", split)
    prepare_run(
        unit,
        split,
        method="baseline/ExtendedIsolationForest",
        partition=partition,
        seed=seed,
        hp=hp,
        resume=resume,
