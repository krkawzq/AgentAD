#!/usr/bin/env python
"""Train CrossAD on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.CrossAD import train
...
def main() -> None:
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/CrossAD/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
