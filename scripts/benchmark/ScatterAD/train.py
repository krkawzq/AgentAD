#!/usr/bin/env python
"""Train ScatterAD on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.ScatterAD import train
...
def main() -> None:
    ...
    handle = _open_log(args, "ScatterAD")
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/ScatterAD/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
