#!/usr/bin/env python
"""Train TSPulse (fine-tuning) on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.TSPulse import train
...
def main() -> None:
    ...
    handle = _open_log(args, "TSPulse-FT")
