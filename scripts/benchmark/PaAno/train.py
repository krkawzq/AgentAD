#!/usr/bin/env python
"""Train PaAno on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.PaAno import train
...
def main() -> None:
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/PaAno/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
