#!/usr/bin/env python
"""Evaluate KMeansDistance on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.kmeans_distance import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/KMeansDistance")
