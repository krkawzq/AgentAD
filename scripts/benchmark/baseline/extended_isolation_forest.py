#!/usr/bin/env python
"""Evaluate ExtendedIsolationForest on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.extended_isolation_forest import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/ExtendedIsolationForest")
