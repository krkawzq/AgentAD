#!/usr/bin/env python
"""Evaluate SpectralResidual on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.spectral_residual import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/SpectralResidual")
