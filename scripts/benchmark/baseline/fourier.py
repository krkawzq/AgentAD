#!/usr/bin/env python
"""Evaluate Fourier on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.fourier import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/Fourier")
