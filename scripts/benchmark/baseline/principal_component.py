#!/usr/bin/env python
"""Evaluate PrincipalComponent on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.principal_component import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/PrincipalComponent")
