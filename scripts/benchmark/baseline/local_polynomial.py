#!/usr/bin/env python
"""Evaluate LocalPolynomial on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.local_polynomial import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/LocalPolynomial")
