#!/usr/bin/env python
"""Evaluate ConnectivityOutlierFactor on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.connectivity_outlier_factor import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/ConnectivityOutlierFactor")
