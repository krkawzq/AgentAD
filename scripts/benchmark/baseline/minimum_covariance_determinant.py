#!/usr/bin/env python
"""Evaluate MinimumCovarianceDeterminant on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.minimum_covariance_determinant import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/MinimumCovarianceDeterminant")
