#!/usr/bin/env python
"""Evaluate Histogram on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.histogram import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/Histogram")
