#!/usr/bin/env python
"""Evaluate IsolationForest on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.isolation_forest import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/IsolationForest")
