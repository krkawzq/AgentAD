#!/usr/bin/env python
"""Evaluate StatisticalFeatures on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.statistical_features import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/StatisticalFeatures")
