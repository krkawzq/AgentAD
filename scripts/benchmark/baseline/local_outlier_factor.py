#!/usr/bin/env python
"""Evaluate LocalOutlierFactor on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.local_outlier_factor import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/LocalOutlierFactor")
