#!/usr/bin/env python
"""Evaluate Copula on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.copula import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/Copula")
