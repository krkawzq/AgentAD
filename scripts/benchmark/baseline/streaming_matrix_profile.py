#!/usr/bin/env python
"""Evaluate StreamingMatrixProfile on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.streaming_matrix_profile import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/StreamingMatrixProfile")
