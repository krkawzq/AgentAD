#!/usr/bin/env python
"""Evaluate OneClassSVM on one TSB-AD dataset unit and print its metric table."""
...
from agentad.methods.baseline.one_class_svm import evaluate
...
def main() -> None:
    ...
    handle = _open_log(args, "baseline/OneClassSVM")
