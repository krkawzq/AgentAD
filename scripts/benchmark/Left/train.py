#!/usr/bin/env python
"""Train Left on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.Left import train
...
def main() -> None:
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/Left/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
