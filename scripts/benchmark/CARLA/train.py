#!/usr/bin/env python
"""Train CARLA on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.CARLA import train
...
def main() -> None:
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/CARLA/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
