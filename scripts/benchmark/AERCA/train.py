#!/usr/bin/env python
"""Train AERCA on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.AERCA import train
...
def main() -> None:
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/AERCA/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
