#!/usr/bin/env python
"""Train KanAD on one TSB-AD dataset unit and store its checkpoints."""
...
from agentad.methods.KanAD import train
...
def main() -> None:
    ...
    try:
        ...
        print(
            ...
            f"{args.output_root}/KAN-AD/<source>/<artifact>/checkpoints/"
        )
        handle.write(
            f"===== done "
